...
export const profile = {
  ...
  linkedInPdf: "/resume/Tirth-Rank-LinkedIn-Profile.pdf",
  headline:
...
Projects include Guest Satisfaction Active Learning and Label Quality Pipeline, LLM Labeling Agent for Trip Experience Intelligence, Multimodal Travel Feedback Analytics and GSAT Prediction System, Literature-Driven GenAI Evaluation Framework, Visual Question Answering model, real-time fruit detection, leaf disease detection, spam email detection, AI noise cancellation, video game sales prediction, secure online banking DBMS, and IoT gesture-controlled Bluetooth speaker.
